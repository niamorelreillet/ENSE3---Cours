...
\end{columns}
\vskip \baselineskip
\textit{cf.} description TD et notebooks Jupyter \\ {\scriptsize (\href{https://mybinder.org/v2/gh/niamorelreillet/ENSE3-Cours/main?urlpath=lab}{https://mybinder.org/v2/gh/niamorelreillet/ENSE3-Cours/main?urlpath=lab})}
\end{frame}
