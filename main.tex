...
\auteurs{\textit{Romain Le Tellier} {\scriptsize (\href{mailto:romain.le-tellier@cea.fr}{\underline{romain.le-tellier@cea.fr}})}, Jules Delacroix, Pascal Piluso}
\datedocument{Décembre 2022 / Janvier 2023}
\institut{IRESNE}
\institutnomlong{}
