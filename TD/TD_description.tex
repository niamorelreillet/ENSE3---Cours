...
\Q{A partir de \(\phi_{lat}^{ox}\), évaluer le maximum local de flux et le comparer à la valeur (pessimiste) de 1.5MW.m$^2$ du flux critique associé au refroidissement externe}
