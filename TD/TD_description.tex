...
\begin{remark}
Bien sûr, si vous installez Jupyterlab sur votre ordinateur (par le biais d'Anaconda par exemple ; voir \href{https://test-jupyter.readthedocs.io/en/latest/install.html}{\color{blue}{\underline{\T{https://test-jupyter.readthedocs.io/en/latest/install.html}}}}), vous pouvez travailler localementx²
\end{remark}
